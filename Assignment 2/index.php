...
$query = 'SELECT customers.customerID, emailAddress, firstName, lastName, line1, city, state, zipCode, phone FROM customers INNER JOIN addresses ON addresses.customerId = customers.customerId GROUP BY customers.customerId';// PUT YOUR SQL QUERY HERE
